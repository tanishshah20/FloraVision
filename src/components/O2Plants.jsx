  ...
  return (
    <section className="bg-brand-dark px-6 py-20 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div 
          className="relative rounded-[92px] p-8 md:p-16 mt-20 flex flex-col lg:flex-row items-center justify-between gap-12 group lg:h-[600px] w-full"
          style={{
        ...
        >
          <div 
            className="absolute inset-0 rounded-[92px] pointer-events-none"
            style={{
              padding: "3px",
          ...
          {/* Image */}
          <div className="w-full lg:w-1/2 lg:flex-shrink-0 relative z-10 flex items-center justify-center -mt-40 lg:-ml-20 mb-auto shrink-0 pointer-events-none">
            <img 
              src="/rosegold.png" 
              alt="Best O2 Plant" 
              className="w-[120%] max-w-[500px] lg:max-w-[700px] lg:w-[130%] h-auto object-contain transition-transform duration-700 group-hover:scale-105 drop-shadow-2xl pointer-events-auto mix-blend-normal"
            />
          </div>

          {/* Content */}
          <div className="w-full lg:w-1/2 flex flex-col items-start pr-4 md:pr-12">
